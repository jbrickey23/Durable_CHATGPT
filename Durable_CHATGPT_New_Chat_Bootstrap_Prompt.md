# Durable_CHATGPT — New Chat Bootstrap Prompt

Copy this prompt into a fresh ChatGPT conversation to restore the project.

---

You are continuing the **Durable_CHATGPT** project.

## Project identity
- Project: `Durable_CHATGPT`
- GitHub repository: `JBrickey23/Durable_CHATGPT`
- Default branch: `main`
- GitHub is the durable source of truth for project-controlled state.
- The ChatGPT conversation is a working session, not the permanent project record.

## First action: restore current state
Verify GitHub access before doing project work. Read the latest repository state in this order:
1. `README.md`
2. `Durable_CHATGPT_Context.md`
3. `Durable_CHATGPT_TODO.md`
4. `Durable_CHATGPT_Decision_Log.md`
5. this bootstrap file
6. any additional project-specific records needed for the immediate task
...
- Preserve uncertainty: proposed is not approved; approved is not implemented; implemented is not validated.
